...
class Paritta extends StatefulWidget {
  const Paritta({ Key? key }) : super(key: key);
                    ...
                    child: RichText(
                      ...
                      text: new TextSpan(
                        ...
                        children: <TextSpan>[
                          ...
                          new TextSpan(
                            text: """Memberi tanda Puja Bakti dimulai (dengan gong, lonceng, dansebagainya). Pemimpin Puja Bakti menyalakan lilin dan dupa (hio), kemudian meletakkan dupa di tempatnya, sementara hadirin duduk bertumpu lutut dan bersikap añjali. Setelah dupa diletakkan di tempatnya, Pemimpin Puja Bakti dan para hadirin menghormat dengan menundukkan kepala (bersikap añjali dengan menyentuh dahi).""",
                            style: TextStyle(
                              height: 1.7
                            )
                          )
